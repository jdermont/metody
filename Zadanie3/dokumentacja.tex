...
Wejœcie
\begin{itemize}
\item krok $h$, w przedziale $(0,1)$ (najlepiej $h < 0.00001$); w przypadku b³êdu program zapyta ponownie
\end{itemize}
\\\\
Wyjœcie
\begin{itemize}
\item wydruk tabelki, który zawiera maksymalnie 21 wierszy; w tabelce znajduj¹ siê:
\begin{itemize}
\item wartoœæ wyliczona dok³adnym równaniem
\item wartoœæ wyliczona metod¹ Eulera
\item wartoœæ wyliczona metod¹ Heuna
\item b³êdy bezglêdne poszczególnych metod wzglêdem rozwi¹zania dok³adnego
\end{itemize}
\end{itemize}
Ca³oœæ programu umieszczona jest w jednym pliku $main.c$.
\ \\
